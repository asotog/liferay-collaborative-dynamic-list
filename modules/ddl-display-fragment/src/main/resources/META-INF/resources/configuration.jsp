...
// Rivet Logic Custom Preferences: WS Custom Config
					...
					<div class="container-fluid-1280">
						<aui:fieldset-group markupView="lexicon">
							<aui:fieldset>
                                ...
                                <!-- Rivet Logic Custom Preferences -->
                                <aui:input label="Use Secured Websocket (SSL)?" name="preferences--wssecured--" type="checkbox" value="<%= wsSecured %>" />
                            
                                <aui:input label="Use Custom Websocket Base Path?" name="preferences--wsusecustomurl--" type="checkbox" value="<%= wsUsecustomurl %>" />
                            
                                <aui:input label="Custom Websocket Base Path" name="preferences--wscustombasepath--" value="<%= wsCustombasepath %>" ></aui:input>
